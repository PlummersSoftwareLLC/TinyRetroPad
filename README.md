...
- [**Dave's Tiny Editor (DTE)**](https://github.com/mpower-codeworks/Daves-Tiny-Editor) — [Matt Power](https://github.com/mpower-codeworks), the sub-1KB RICHEDIT editor this fork is built on.
